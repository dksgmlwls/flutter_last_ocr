...
class MaternityGraphPage extends StatefulWidget {
  static const routeName = '/camera-page';

  const MaternityGraphPage({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  MaternityGraphPageState createState() => MaternityGraphPageState();
}

class MaternityGraphPageState extends State<MaternityGraphPage> {
